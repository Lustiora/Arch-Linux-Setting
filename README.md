...
참고<br>
[ArchWiki](https://wiki.archlinux.org/title/Main_page)<br>
[Installation guide](https://wiki.archlinux.org/title/Installation_guide)<br>
[General recommendations](https://wiki.archlinux.org/title/General_recommendations)<br>
<br>
목차<br>
[Part 1. Arch Linux Base Install](https://github.com/Lustiora/Arch-Linux-Setting/issues/1)<br>
...
Discover Setup은 동작 오류 발생 가능성이 높으니 설치 자제
